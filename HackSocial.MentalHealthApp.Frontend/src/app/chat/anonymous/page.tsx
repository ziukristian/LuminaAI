  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content:
        "Hello! I am Lumina, your AI Mental Health Buddy. You're chatting anonymously, so feel free to share whatever is on your mind. I'm here to listen and support you. How are you feeling today?",
      sender: "ai",
      timestamp: new Date(),
    },
  ])
        ...
        <div className="p-4 bg-sage-25 border-b border-sage-100">
          <div className="space-y-2">
            ...
            <p className="text-xs text-sage-600">
              Your conversation is completely private. No account needed, no data stored.
            </p>
            <Button size="sm" variant="outline" className="w-full border-sage-300 text-sage-700 bg-transparent" asChild>
              <Link href="/auth/signup">Create Account for More Features</Link>
            </Button>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-sage-600">Anonymous Session Active</span>
                </div>
              </div>
            </div>
        ...
        <div className="p-4 border-t border-sage-100 bg-white">
          ...
          <p className="text-xs text-sage-500 mt-2 text-center">
            Your anonymous conversation is private and encrypted. Press Enter to send, Shift+Enter for new line.
          </p>
        </div>
      </div>
    </div>
